    ...
    <Navbar expand="lg">
      ...
      <Navbar.Collapse>
            <Nav className="mr-auto">
              ...
              <Nav.Link componentClass={Link} href="/privacy-policy" to="/privacy-policy">
                Privacy Policy
              </Nav.Link>
              <Nav.Link componentClass={Link} href="https://www.matthewbwright.dev/" to="matthewbwright.dev">
